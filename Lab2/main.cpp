...
int main() {
	...
	for (int stop = 0; stop < 1; stop) {
		...
		case 6: {
			...
			std::cout << "Количество элеменнтов в массиве, которые больше b " << b << ": " << numbOfVarr << "\n\n";
			break;
		}
		...
		case 9:{
			...
			std::cout << "Нечетные элемены массива уменишины на n. Четные - умножены на случайное число от 1 до 9:\n";
			printArray(arr, 100);
			std::cout <<
